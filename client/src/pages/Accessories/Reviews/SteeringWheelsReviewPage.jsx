...
import SteeringWheelsReview from '../../../components/Accessories/Reviews/SteeringWheelsReview';

export const SteeringWheelsReviewContext = createContext();

export default function SteeringWheelsReviewPage() {
  ...
  return (
    <Box>
        <SteeringWheelsReviewContext.Provider value={review}>
            <SteeringWheelsReview review={review}/>
        </SteeringWheelsReviewContext.Provider>
                            ...
                            <Box key={item._id} width={{md: '300px', base: '100%'}} bg={useColorModeValue('gray.200')} padding={3} rounded={5}>
                                ...
                                <Box mt={4} color={'gray.800'}>
                                    ...
                                    <Flex justifyContent={'space-between'} alignItems={'center'} pt={3} mt={2} borderTop={'2px'} borderTopColor={'gray.300'}>
                                        <Box fontWeight={500} >
                                            <Link to={`/review-steeringwheel-reviews/${item._id}`} className='text-blue-500'>Review</Link>
                                        </Box>
                                        <Box>
