...
import BumperReview from '../../../components/Accessories/Reviews/BumperReview';
import Footer from '../../../components/Footer';
import Header from '../../../components/Header';

export const BumperReviewContext = createContext();

export default function BumperReviewPage() {
  ...
  return (
    <Box>
        <Header/>
      <BumperReviewContext.Provider value={review}>
        <BumperReview review={review}/>
      </BumperReviewContext.Provider>

      {/* <Box>
        <Text>{review.BumperImage}</Text>
      </Box> */}
                                    ...
                                    <Box mt={4} color={useColorModeValue('gray.800', 'gray.200')}>
                                        ...
                                        <Flex justifyContent={'center'} alignItems={'center'} pt={3} mt={2} borderTop={'1px'} borderTopColor={'gray.600'}>
                                            <Flex justifyContent={'center'} alignItems={'center'} fontWeight={500} bg={useColorModeValue('blue.500', 'white')} color={useColorModeValue('white', 'black')} width={'100%'} height={'40px'} rounded={3}>
                                                <Link to={`/review-bumper-reviews/${item._id}`} className=''>Review</Link>
                                            </Flex>
                                        </Flex>
                                    </Box>
                                </Box>
