...
export default function AmplifierPage2() {
  ...
  return (
    <Box>
        <Header/>
        <Flex mt={10} flexWrap={{md: 'nowrap', base: 'wrap'}} gap={6} px={3} py={7} width={{md: '90%', base: '100%'}} mx={'auto'} bg={useColorModeValue('gray.200', 'gray.700')}>
        <Box width={{md: '40%', base: '100%'}} bg={useColorModeValue('white', 'gray.800')} rounded={10}>
                <Flex justifyContent={{md: 'center', base: 'center'}}>
                    {
                        review.accessoryImage === undefined ? '' : (
                            <Flex justifyContent={'center'} alignItems={'center'} position={'relative'} height={{md:'350px', base: '350px'}} width={{md:'350px', base: '300px'}} p={3} rounded={5}>
                                <Image src={review.accessoryImage[0]} ref={display} maxW={'300px'} maxH={'300px'} rounded={5}/>
            ...
            <Box mt={5} flex={1}>
                ...
                <Text fontWeight={500} mt={3} fontSize={{md:15, base:14}} wordBreak={'break-word'}>{review.descriptions}</Text>
                <Flex gap={4} mt={2}>
