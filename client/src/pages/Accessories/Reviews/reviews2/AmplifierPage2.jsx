...
export default function AmplifierPage2() {
  ...
  return (
    <Box>
        <Flex mt={10} flexWrap={{md: 'nowrap', base: 'wrap'}} gap={6} px={3} py={7} width={{md: '90%', base: '100%'}} mx={'auto'} bg={'gray.200'}>
                ...
                <Flex justifyContent={{md: 'start', base: 'center'}}>
                    {
                        review.amplifierImage === undefined ? '' : (
                            ...
                            position={'relative'} height={{md:'350px', base: '300px'}} width={{md:'350px', base: '300px'}} p={3} rounded={5}>
                                <Image src={review.amplifierImage[0]} ref={display} maxW={'100%'} rounded={5}/>
                                <Flex justifyContent={'center'} position={'absolute'} top={0} left={0} width={'70px'} borderTopLeftRadius={5} py={1} bg={'gray.200'}>
                                    <Text fontWeight={500}>{review.amplifierImage.length} Photo</Text>
                                </Flex>
                            </Flex>
                        )
                    }
                ...
                <Flex alignItems={'center'} justifyContent={'center'} bg={useColorModeValue('')} gap={3} flexWrap={'wrap'}  p={1}>
                    {
                        review.amplifierImage === undefined ? '' : (
                            <>
                                {
                                    review.amplifierImage.map((img, index) => (
