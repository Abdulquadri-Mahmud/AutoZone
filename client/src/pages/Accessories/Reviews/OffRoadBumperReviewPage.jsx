...
import OffRoadBumperReview from '../../../components/Accessories/Reviews/OffRoadBumperReview';

export const OffRoadBumperReviewContext = createContext();


export default function OffRoadBumperReviewPage() {
  ...
  return (
    <Box>
        <OffRoadBumperReviewContext.Provider value={review}>
            <OffRoadBumperReview review={review}/>
        </OffRoadBumperReviewContext.Provider>
                            ...
                            <Box key={item._id} width={{md: '300px', base: '100%'}} bg={useColorModeValue('gray.200')} padding={3} rounded={5}>
                                ...
                                <Box mt={4} color={'gray.800'}>
                                    ...
                                    <Flex justifyContent={'space-between'} alignItems={'center'} pt={3} mt={2} borderTop={'2px'} borderTopColor={'gray.300'}>
                                        <Box fontWeight={500} >
                                            <Link to={`/review-offroadbumper-reviews/${item._id}`} className='text-blue-500'>Review</Link>
                                        </Box>
                                        <Box>
