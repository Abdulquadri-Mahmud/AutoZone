  ...
  return (
    <>
        ...
        <Drawer onClose={onClose} size={{lg: 'lg',md: 'md', base: 'xs'}} isOpen={isOpen}>
            <DrawerOverlay />
            <DrawerContent>
                <DrawerCloseButton bg={'blue.500'} color={'white'} mt={2}/>
                <DrawerHeader className='shadow-sm'>Accessories</DrawerHeader>
                <DrawerBody mt={10}>
                    <Flex gap={5} flexWrap={'wrap'}>
                        <Box width={{md:'45%', base: '100%'}}>
                            <Box>
                                <Heading color={'blue.500'} fontSize={20} fontWeight={500}>AUDIO</Heading>
                            </Box>
                            ...
                            {/* accessories 2 */}
                        <Box width={'0%'} padding={'2px'} rounded={'30px'} bg={'blue.500'} className='col-span-3' display={{md: 'block', base: 'none'}}></Box>
                        <Box width={{md:'40%', base: '100%'}} pl={{md: 5, base: 0}}>
                            <Box>
                                <Heading color={'blue.500'} fontSize={20} fontWeight={500}>BODY PARTS</Heading>
                            </Box>
                            <Stack mt={3} fontWeight={400} >
                        ...
                        <Box width={{md:'45%', base: '100%'}}>
                            <Box>
                                <Heading color={'blue.500'} fontSize={20} fontWeight={500}>EXTERIOR</Heading>
                            </Box>
                            <Stack mt={3} fontWeight={400} >
                        ...
                        <Box width={{md:'40%', base: '100%'}} pl={{md: 5, base: 0}}>
                            <Box>
                                <Heading color={'blue.500'} fontSize={20} fontWeight={500}>INTERIOR</Heading>
                            </Box>
                            <Stack mt={3} fontWeight={400} >
                        ...
                        <Box width={{md:'45%', base: '100%'}}>
                            <Box>
                                <Heading color={'blue.500'} fontSize={20} fontWeight={500}>LIGHTING</Heading>
                            </Box>
                            <Stack mt={3} fontWeight={400} >
