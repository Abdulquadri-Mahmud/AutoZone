                ...
                <Flex gap={{md: 10, base: 3}} justifyContent={'start'} flexWrap={'wrap'} rounded={5} key={car._id} bg={useColorModeValue('gray.200', 'gray.700')} mb={3} padding={6} position={'relative'}>
                  ...
                  <Box width={{md: '30%', base: '100%'}} >
                    ...
                    <Flex alignItems={'center'} gap={1} className="rate" mt={2}>
                      ...
                      <Box mt={4} rounded={5} bg={useColorModeValue('gray.100', 'gray.800')} p={4} width={'full'}>
                  ...
                  <Box width={{md: '30%', base: '100%'}} >
                    ...
                    <Flex justifyContent={'space-between'} mt={2}>
                      <Text className='flex items-center gap-1 font-bold' color={useColorModeValue('gray.600', 'gray.200')}>Price: <span className='flex items-center font-medium'><BsCurrencyDollar className='text-sm'/>{car.price}</span></Text>
                      <Text className='flex items-center gap-1 font-bold' color={useColorModeValue('gray.600', 'gray.200')}><span className='flex items-center font-medium'><IoLocationOutline className='text-blue-500'/>{car.location}</span></Text>
                    </Flex>
                    <Flex justifyContent={'space-between'} alignItems={'center'} pt={3} mt={2} borderTop={'2px'} borderTopColor={'gray.300'}>
                      ...
                      <Box>
                        <Button onClick={() => handleAddToCart2(car)}><LuShoppingCart className='text-xl text-blue-500'/></Button>
                      </Box>
                    </Flex>
                  </Box>
