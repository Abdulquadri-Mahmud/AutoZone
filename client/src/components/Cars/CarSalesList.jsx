          ...
          <Box padding={{ md: 2, base: 0 }}>
            <form className="bg-slate-50 p-3 rounded-md flex md:flex-col flex-row flex-wrap items-start justify-start gap-2">
              <Box mt={0} width={{ md: "100%", base: "33%" }}>
                <span className="font-medium text-center text-slate-500 text-sm">
                  Condition:
                </span>
                <select
                  className="mt-2 w-full text-gray-600 text-sm p-3 rounded-md font-medium border-none outline-none shadow"
              ...
              <Box
                ...
                className="flex md:flex-col flex-row items-center gap-2 smaller-screen"
              >
                <Box
                  mt={{ md: 4, base: 0 }}
              ...
              <Tabs position={"relative"} variant="unstyled">
                ...
                >
                  <Tab
                    width={"70px"}
                    color={"white"}
                    _hover={{ bg: useColorModeValue("blue.400") }}
                  >
                        ...
                        cars.map((car) => (
                          ...
                          >
                            ...
                            <Flex justifyContent={"space-between"} mt={2}>
                              ...
                              >
                                Deal:{" "}
                                <span className="font-medium">{car.deal}</span>
                              </Text>
                            </Flex>
                            <Flex justifyContent={"space-between"} mt={2}>
                              <Text className="flex items-center gap-1 font-bold">
                                Price:{" "}
