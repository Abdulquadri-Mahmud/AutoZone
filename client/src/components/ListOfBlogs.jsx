...
export default function ListOfBlogs() {
  ...
  return (
    <Box p={{md: '0rem', base: '0.5rem'}} py={{md: 10, base: 10}} mt={5} maxW={{md: '95%', base: '100%'}} mx={'auto'} rounded={10} bg={useColorModeValue('gray.200', 'gray.700')} shadow={'md'}>
        <Box>
            <Box width={{md: '300px', base: '70%'}} ml={useColorModeValue(0, 6)} bg={useColorModeValue('blue.500', 'gray.800')} rounded={5} p={4} borderBottomWidth={1} borderBottomColor={useColorModeValue('gray.300', 'gray.500')}>
                    ...
                    blogs.length > 0 ? (
                        blogs.map((blog) => (
                            ...
                            color={'black'} borderWidth={1} borderColor={useColorModeValue('', 'gray.600')}>
                                ...
                                <Box roundedBottom={10}padding={3} color={useColorModeValue('white', 'white')} bg={useColorModeValue('blue.500', 'gray.800')}>
