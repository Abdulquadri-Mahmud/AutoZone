...
import { SteeringWheelsReviewContext } from '../../../pages/Accessories/Reviews/SteeringWheelsReviewPage';

export default function SteeringWheelsReview() {
    const item = useContext(SteeringWheelsReviewContext);
    
    return (
      <Flex gap={6} flexWrap={'wrap'} mt={10} px={3} py={7} width={{md: '80%', base: '100%'}} mx={'auto'} bg={'gray.200'}>
          <Box>
              ...
              <Flex position={'relative'} justifyContent={'center'} height={'250px'} mt={5} bg={useColorModeValue('white')} width={'300px'} padding={3} rounded={5}>
                  {
                      item.SteeringWheelsImage === undefined ? '' : (
          ...
          <Box mt={5} flex={1}>
              ...
              <Flex gap={8} alignItems={'center'}mt={4}>
                  ...
                  <Text fontWeight={500} my={3} className='flex items-center'>Price: <sup><BsCurrencyDollar/> </sup> {item.price}.00</Text>
