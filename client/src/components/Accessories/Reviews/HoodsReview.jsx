...
export default function HoodsReview() {
  ...
  return (
    <Flex gap={6} mt={10} px={3} py={7} width={{md: '90%', base: '100%'}} mx={'auto'} bg={'gray.200'}>
            ...
            <Flex justifyContent={{md: 'start', base: 'center'}}>
                {
                    item.HoodsImage === undefined ? '' : (
                        ...
                        position={'relative'} height={{md:'350px', base: '300px'}} width={{md:'350px', base: '300px'}} p={3} rounded={5}>
                            <Image src={item.HoodsImage[0]} ref={display} maxW={'100%'} rounded={5}/>
                            <Flex justifyContent={'center'} position={'absolute'} top={0} left={0} width={'70px'} borderTopLeftRadius={5} py={1} bg={'gray.200'}>
                                <Text fontWeight={500}>{item.HoodsImage.length} Photo</Text>
                            </Flex>
                        </Flex>
                    )
                }
